// FloatingWhatsApp Component (Custom Implementation)
const FloatingWhatsApp = ({ phoneNumber, accountName, chatMessage, statusMessage }) => {
    const [isOpen, setIsOpen] = useState(false);
    const [hasNotification, setHasNotification] = useState(true);

    const handleClick = () => {
        const message = encodeURIComponent(chatMessage || "Hello!");
    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 w-16 h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl flex items-center justify-center transition-all transform hover:scale-110 z-50"
            >
                {hasNotification && (
